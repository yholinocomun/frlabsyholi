"""
Fundamentos de Robotica 2025-2 - UTEC
Prof. Alexander Lopez y Oscar Ramos
File: markers.py
"""
...
class FrameMarker(object):
    ...
    def __init__(self, node, color_saturation=1.0, alpha=1.0, scale=0.1):
        ...
        self.markerx.lifetime = rclpy.duration.Duration(seconds=0).to_msg()
        self.markery.lifetime = rclpy.duration.Duration(seconds=0).to_msg()
        self.markerz.lifetime = rclpy.duration.Duration(seconds=0).to_msg()
